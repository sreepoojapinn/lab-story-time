...
function sweetTooth(totalNoOfSweets, sweetsConsumedByKaren, sweetsConsumedInmeter, metersToTravel) {
    var remaining = totalNoOfSweets - (sweetsConsumedByKaren + sweetsConsumedInmeter +  metersToTravel)
